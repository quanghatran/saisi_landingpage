          ...
          <Nav>
            <LeftSide>
              <div id={showLinks ? 'hidden' : ''}>
                ...
                <Dropdown>
                  <Header>
                    <Link to='/ve-satsi' onClick={() => handleClickLink()}>
                      VỀ SATSI
                    </Link>
                  </Header>
                  {/* {dropDown === 1 ?
                                ...
                                >
                                    <DropdownItem><Link onClick={handleClickLink} to="/tam-nhin">TẦM NHÌN</Link></DropdownItem>
                                    <DropdownItem><Link onClick={handleClickLink} to="/su-menh">SỨ MỆNH - GIÁ TRỊ CỐT LÕI</Link></DropdownItem>
                                    <DropdownItem><Link onClick={handleClickLink} to="/so-do-lanh-dao">SƠ ĐỒ LÃNH ĐẠO</Link></DropdownItem>
                                </DropdownMenu> :
                                ''
                                } */}
                </Dropdown>
                <Dropdown>
                  <Header>
                    <Link
                      ...
                      onMouseLeave={() => HandleMouseLeave()}
                    >
                      DU HỌC NGHỀ ĐỨC<i className='fas fa-angle-down'></i>
                    </Link>
                  </Header>
                  {dropDown === 2 ? (
                    <DropdownMenu
                      ...
                      onMouseLeave={() => HandleMouseLeave()}
                    >
                      {/* <DropdownItem><Link onClick={handleClickLink} to="#">DU HỌC NGHỀ ĐỨC</Link></DropdownItem> */}
                      <DropdownItem>
                        <Link
                ...
                <Dropdown>
                  <Header>
                    <Link onClick={handleClickLink} to='/khoa-hoc-cong-nghe'>
                      KHOA HỌC & CÔNG NGHỆ
                    </Link>
                  </Header>
                </Dropdown>
