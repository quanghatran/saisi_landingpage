...
const ContactForm = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const inforCustomer = {Name: name, PhoneNumber: phoneNumber, Email: email, Service: service};
        ...
        <Container>
            <StyledWrapper>
                <Title>
                    ...
                    <p>Hãy để SATSi là cánh tay nối dài giúp bạn tự tin trên hành trình kiến tạo tương lai của mình. Kết nối với chúng tôi để nhận được hỗ trợ uy tín và chuyên nghiệp!</p>
                </Title>
                    ...
                    <div className="form-row">
                        ...
                        <div className="input-data">
                            ...
                            >
                                ...
                                <option value="Đào tạo nghiệp vụ hàng không">Đào tạo nghiệp vụ hàng không</option>
                            </select>
                        </div>
                    </div>
