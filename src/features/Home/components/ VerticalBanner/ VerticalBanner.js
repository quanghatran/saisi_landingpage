      ...
      {isDisplay && (
        <div className='Stiky'>
          ...
          <div className='VB-body' onClick={redirect}>
            ...
            <div className='VB-line VB-Title'>
              <img src={MinhTrietText} alt='img' />
            </div>
            <div className='VB-line'>
              <img src={Line} alt='img' />
            </div>
            <div className='VB-intro'>
              <img src={IntroMinhTriet} alt='img' />
            </div>
            <div className='VB-CircleNUmberic'>
              <img src={CircleNumberic} alt='img' />
            </div>
            <div className='VB-intro2'>
              <img src={MinhTrietText2} alt='img' />
            </div>
          </div>
        </div>
      )}
      {isDisplay && (
        <div className='VerticalBannerMobile'>
          <ClearIcon
            ...
            onClick={handleClose}
            style={{ color: '#fff', zIndex: 3, fontSize: '20px' }}
          />
          <div className='VBM-background'>
            <img src={BackgroundImage} alt='img' />
          </div>
          <div className='VBM-body' onClick={redirect}>
            ...
            <div className='VBM-line'>
              <img src={Line} alt='img' />
            </div>
            <div className='VBM-line VB-Title'>
              <img src={MinhTrietText} alt='img' />
            </div>
            <div className='VBM-line'>
              <img src={Line} alt='img' />
            </div>
            <div className='VBM-CircleNUmberic'>
              <img src={CircleNumberic} alt='img' />
            </div>
          </div>
        </div>
